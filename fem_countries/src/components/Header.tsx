...
export function Header() {
  ...
  return (
    <header className="w-full bg-white dark:bg-brand-blue-700 h-20 px-4 md:px-12 py-8 flex items-center justify-between dark:text-brand-gray-light shadow-md">
